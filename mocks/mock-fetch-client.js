 ...
 * @Last Modified time: 2020-01-30 01:58:04
 */
...
const mockFetchClient = (() => {
  ...
  const UNAUTHORIZED_RESPONSE = '{ "message": "Bad credentials" }';

  const makeUserDoesNotExist = (user) => {
    const response = `{ "data": { "user": null }, "errors": [ { "message": "Could not resolve to a User with the login of \'${user}\'." } ] }`;
  }
